...
namespace Dragon\system\Config;
...
class AutoloadConfig
{
     ...
     * to locate files the first time they have been instantiated.
     *
     * Do not change the name of the Dragon\system namespace or your application
     * will break.
     *
     * @var array<string, string>
     */
    protected $corePsr4 = [
        'Dragon\system' => SYSTEMPATH,
        'Dragon'         => APPPATH, // To ensure filters, etc still found,
    ];
    ...
    {
        // if (isset($_SERVER['Dragon_ENVIRONTMENT']) && $_SERVER['Dragon_ENVIRONTMENT'] === 'testing') {
        //     $this->psr4['Tests\Support']                  = SUPPORTPATH;
        //     $this->classmap['Dragon\Log\TestLogger'] = SYSTEMPATH . 'Test/TestLogger.php';
        //     $this->classmap['DragonDatabaseTestCase']         = SYSTEMPATH . 'Test/DragonDatabaseTestCase.php';
        // }
